// import { StartFunc as StartFuncToLocalStorage } from "../../../../ToLocalStorage/AddOnData/DeleteFunc.js";
import { StartFunc as StartFuncToLocalStorage } from "../../../../../../ToLocalStorage/AddOnData/DeleteFunc.js";
...
const jFLocalDeleteFunc = ({ inEvent, inItemSerial }) => {
    ...
    let jVarLocalFromDelete = StartFuncToLocalStorage({ inKey: jVarLocalPk });
