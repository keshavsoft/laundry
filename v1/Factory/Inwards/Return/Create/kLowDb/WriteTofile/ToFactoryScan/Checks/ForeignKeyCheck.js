...
import folderNameJson from '../../../../../tableName.json' assert {type: 'json'};

let LocalFuncPullData = ({ inFileName }) => {
    console.log("inFileName:",inFileName);
    
    let LocalFilePath = `${Configjson.jsonConfig.DataPath}/${Configjson.jsonConfig.DataPk}/QrCodes/${inFileName}.json`;
